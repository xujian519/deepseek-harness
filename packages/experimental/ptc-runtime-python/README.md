...
| File | Role |
|---|---|
| [`src/index.ts`](src/index.ts) | Plugin entry: `PythonPtcRuntime` — registration, binding validation, per-run staging; re-exports the protocol vocabulary and the configuration surface |
