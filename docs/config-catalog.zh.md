...
Source: [`packages/web/synapse/src/index.ts:31`](../packages/web/synapse/src/index.ts)
...
Source: [`packages/patent/tool-literature/src/index.ts:48`](../packages/patent/tool-literature/src/index.ts)
