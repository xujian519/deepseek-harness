...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_subagent_models', 'lsp', 'market_plugin_preview', 'market_plugin_search', 'market_source_list',
      'paper_download', 'paper_list_sources', 'paper_search', 'patent_analysis_report', 'patent_case_search', 'patent_eval',
      ...
      'patent_teams_remove_member', 'patent_teams_send_message', 'patent_teams_status', 'patent_teams_update_task',
      'patent_wiki_search', 'patent_worker_validate',
      'patent_workflow', 'patent_workflow_run', 'pwsh', 'pwsh', 'ralph', 'read', 'read_image',
      'recognize_chemical_structure', 'render_patent_document', 'report', 'rule_check', 'run_code',
      'schedule_create', 'schedule_delete', 'schedule_list', 'search_patent_figure',
      ...
      'terminal_signal', 'todo_write', 'triz', 'update_goal', 'validate_specification',
