...
import {
  existsSync, mkdirSync, readFileSync, readdirSync, readlinkSync, realpathSync, rmSync, statSync,
...
export function loadProfile(
  ...
  if (!existsSync(join(dir, 'package.json'))) {
    ...
    initProfile(dir, template.bundles, { overrides: profileCoreOverrides(installAnchor) })
  }
