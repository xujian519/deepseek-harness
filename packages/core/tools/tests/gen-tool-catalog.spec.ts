...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_subagent_models', 'lsp', 'macos_app', 'macos_clipboard_get', 'macos_clipboard_set',
      'macos_notify', 'macos_open_path', 'macos_open_url', 'macos_speak', 'market_plugin_preview',
      'market_plugin_search', 'market_source_list', 'paper_download', 'paper_list_sources',
      'paper_search', 'patent_analysis_report', 'patent_case_search', 'patent_eval', 'patent_kg_query',
      'patent_legal_status', 'patent_metadata', 'patent_pdf_download', 'patent_plan_task',
      'patent_search', 'patent_teams_add_member', 'patent_teams_archive', 'patent_teams_claim_task',
