...
// macOS targets resolve notarization and the mandatory-update policy from the
// release environment; the Windows targets read neither, so the fixture
// carries all three for both.
const environment = { DSH_DESKTOP_APP_ID: 'com.example.test', DSH_DESKTOP_AUTO_UPDATE_ENV: 'test',
  ...
  APPLE_KEYCHAIN_PROFILE: 'fixture-keychain-profile',
