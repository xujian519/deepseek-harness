...
export interface IApiClient {
  ...
  host: {
    ...
    readFileText(payload: RequestPayload<'host.readFileText'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.readFileText'>>>
  }
  workspace: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'host.readFileText': hostReadFileTextValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly host: IApiClient['host'] = {
    ...
    readFileText: (payload, signal) => this.callUnary('host.readFileText', payload, signal),
  }
