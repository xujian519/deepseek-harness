...
- 创建日期：2026-08-19
- 状态：**计划（待批准执行）**——2026-08-19 评审通过「可落地」，纳入 deepseek-harness 文档计划体系；本文件为唯一正本（同日从仓库根目录迁入 `docs/`）
...
| **预设设计** | `patent-mode-design.md`：五层架构（人设/工具面/技能层/流程层/知识库）、五大流水线 L1–L5、三大 HITL 确认点、七道幻觉防线、证据链契约 | ✅ 设计完成，**尚未落地** |
