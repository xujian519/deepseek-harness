...
| [`patent-tools/`](patent-tools/README.md) | Model-facing patent tool set (search/metadata/legal-status/case-search/draft/render/rule-check/triz-analysis). | (registers on `ctx.tools`) |
