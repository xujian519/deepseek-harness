...
`)
  ...
  // Repository-wide TypeScript extraction and reachable-node hashing use the
  // Windows coverage test budget; the loaded Linux coverage lane ran it past
  // 93s against an idle 16s.
