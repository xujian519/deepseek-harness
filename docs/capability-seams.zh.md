...
| `ctx.desktop` | `seam` | [`desktop`](../packages/desktop/desktop) | [`desktop-shell`](../packages/desktop/shell) | [`desktop-directory-picker`](../packages/desktop/directory-picker) | - | Electron Main 拥有原生对话框、通知、菜单、全局快捷键、托盘和拖放；shell provider 通过本地 socket 将这些能力桥接到后端，使渲染进程保持沙箱化。 |
