...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'job_list', 'job_output', 'knowledge_note_save', 'law_verify', 'list_agents', 'list_agents', 'list_doc_templates', 'list_mcp_resource_templates', 'list_mcp_resources',
      ...
      'triz', 'triz_contradiction_analysis', 'update_goal', 'validate_specification', 'wait_agent', 'web_fetch', 'web_search', 'workbench_link_patent_case', 'workflow',
      'write',
    ])
