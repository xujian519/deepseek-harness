...
- The example benchmark now carries a problem-space DAG and a thresholded regression gate (`examples/patent-oas/problem-space.yaml`, `examples/patent-oas/gate.yaml`) judged by `pnpm run verify-patent-oas-gold` ([rationale](../process/2026-09-26-patent-oas-problem-space-gate.md)).
