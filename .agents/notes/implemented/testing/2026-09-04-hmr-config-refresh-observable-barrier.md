...
The config-refresh cases in `packages/boot/app-boot/tests/config-reload.spec.ts` observe real filesystem events through chokidar. Two of them failed intermittently under CI concurrency.
