/**
 * src/atoms — Pipeline 原子操作 barrel。
 *
...
import { globalAtomRegistry } from './atom.ts'
import { globalStageHandlerRegistry } from './handler.ts'
import * as builtin from './handlers/builtin/index.ts'
