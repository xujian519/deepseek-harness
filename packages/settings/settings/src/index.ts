...
/**
 * Validate and brand one settings namespace string for registration-time use.
 * @param value - candidate namespace; lowercase letter first, then lowercase
 * letters, digits, or hyphens.
 * @returns the same string with the SettingsNamespace brand.
 */
