...
export function registerPatentTeamsTools(ctx: Context): void {
  ...
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      role: { type: 'string', description: 'Role of the member (e.g. case-manager, researcher, drafter, technical-expert, adversarial-reviewer, applicant-counsel, formal-examiner, invalidity-petitioner, patentee-defender, adjudicator, defendant-counsel, tech-investigator, document-specialist).' },
