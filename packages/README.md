...
| [`patent/`](patent/README.md) | Sati patent-domain capability family: data/knowledge seams, engines, tools, rule gates, document rendering, literature, methodology | Product — stable API |
