/**
 * Self-evolve bundle glue: the runtime plugin mounts without throwing and the
 * invariant companion registers a disposer.
 */
...
describe('dsh-self-evolve-app glue', () => {
  ...
  it('invariant companion registers a disposer', async () => {
    ...
    expect(name).toBe('self-evolve-app-invariant')
