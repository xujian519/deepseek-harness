 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-(?:file-reference|session|llm|tools|brand|util-crypto|util-workspace-path|value)(?:\/|$)|@deepseek-ai\/dsh-token-meter\/client$)/
