...
| Verdict | Below. Budgets are the recorded reference medians scaled by the shared CI time scale and variance headroom, and the transient-heap budgets use only the headroom |
