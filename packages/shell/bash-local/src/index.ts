...
export function assertServiceableBashConfig(config: Config): void {
  assertPositiveFinite('bash-local: timeoutMs', config.timeoutMs.get())
  assertPositiveFinite('bash-local: maxTimeoutMs', config.maxTimeoutMs.get())
  assertPositiveFinite('bash-local: maxOutputBytes', config.maxOutputBytes.get())
  assertPositiveFinite('bash-local: maxSpillBytes', config.maxSpillBytes.get())
  assertPositiveFinite('bash-local: graceMs', config.graceMs.get())
