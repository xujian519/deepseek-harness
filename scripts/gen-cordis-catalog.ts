...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  DynamicCordisApprovalInfo: 'dynamic-package payload contract is owned by packages/extensions/cordis-host-runner/src/types.ts',
  ...
  OpenDialogOptions: 'desktop dialog options are owned by packages/desktop/desktop/README.md',
  SaveDialogOptions: 'desktop dialog options are owned by packages/desktop/desktop/README.md',
  ...
  CreateNuoSearchProviderOptions: 'service-local search provider options are owned by packages/patent/patent-data/src/index.ts',
  EgoBrowserSession: 'service-local ego-browser session runner is owned by packages/patent/patent-data/src/index.ts',
  EgoSessionOptions: 'service-local ego-session options are owned by packages/patent/patent-data/src/index.ts',
  StageProvider: 'patent workflow search-stage contract is owned by packages/patent/patent-core/src/types.ts',
  PatentAgent: 'patent workflow agent face is owned by packages/patent/patent-workflow/src/types.ts',
  PlantaskRunOptions: 'patent workflow plantask-run options are owned by packages/patent/patent-workflow/src/types.ts',
  PlantaskRunResult: 'patent workflow plantask-run result is owned by packages/patent/patent-workflow/src/types.ts',
  StageExecutor: 'patent workflow stage executor contract is owned by packages/patent/patent-core/src/workflow/types.ts',
  WorkflowContext: 'patent workflow context is owned by packages/patent/patent-core/src/workflow/types.ts',
  WorkflowManifest: 'patent workflow manifest is owned by packages/patent/patent-core/src/workflow/types.ts',
  WorkflowRunOptions: 'patent workflow run options are owned by packages/patent/patent-core/src/workflow/types.ts',
  WorkflowRunResult: 'patent workflow run result is owned by packages/patent/patent-core/src/workflow/types.ts',
  CaseLawHit: 'service-local case-law search result is owned by packages/patent/patent-knowledge/src/case-law/types.ts',
  CaseLawSearchOptions: 'service-local case-law search options are owned by packages/patent/patent-knowledge/src/case-law/types.ts',
  KnowledgeLawSearchOptions: 'service-local legal search options are owned by packages/patent/patent-knowledge/src/legal/knowledge-law-search.ts',
  LawSearchResult: 'service-local legal search result is owned by packages/patent/patent-knowledge/src/legal/types.ts',
  WikiCardMeta: 'service-local wiki-card metadata is owned by packages/patent/patent-knowledge/src/patent/wiki-card-loader.ts',
  IpcClassification: 'service-local IPC classification result is owned by packages/patent/patent-core/src/ipc/types.ts',
  IpcStandardCard: 'service-local IPC examination-standard card is owned by packages/patent/patent-core/src/ipc/types.ts',
  KgNode: 'service-local knowledge-graph node is owned by packages/patent/patent-knowledge/src/patent/types.ts',
  ...
  CreateTaskArgs: 'service-local task-creation arguments are owned by packages/patent/patent-teams/src/task-ops.ts',
  CreateTaskResult: 'service-local task-creation result is owned by packages/patent/patent-teams/src/task-ops.ts',
  ReassignTaskArgs: 'service-local task-reassignment arguments are owned by packages/patent/patent-teams/src/task-ops.ts',
  ReassignTaskResult: 'service-local task-reassignment result is owned by packages/patent/patent-teams/src/task-ops.ts',
  ClaimTaskArgs: 'service-local task-claim arguments are owned by packages/patent/patent-teams/src/task-ops.ts',
  ClaimTaskResult: 'service-local task-claim result is owned by packages/patent/patent-teams/src/task-ops.ts',
  UpdateTaskArgs: 'service-local task-update arguments are owned by packages/patent/patent-teams/src/task-ops.ts',
  UpdateTaskResult: 'service-local task-update result is owned by packages/patent/patent-teams/src/task-ops.ts',
  AddMemberArgs: 'service-local member-admission arguments are owned by packages/patent/patent-teams/src/member-runtime.ts',
  AddMemberResult: 'service-local member-admission result is owned by packages/patent/patent-teams/src/member-runtime.ts',
  RemoveMemberResult: 'service-local member-removal result is owned by packages/patent/patent-teams/src/member-runtime.ts',
