...
function fixture(): string {
  // macOS resolves /var under /private/var; building the fixture root from the
  // real path keeps vite's root-relative html output names from climbing out of
  // the temp tree when the configured input path carries the unresolved prefix.
