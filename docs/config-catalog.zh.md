...
来源：[`packages/patent/patent-tools/src/index.ts:117`](../packages/patent/patent-tools/src/index.ts)
...
来源：[`packages/core/system-prompt/src/index.ts:217`](../packages/core/system-prompt/src/index.ts)
...
来源：[`packages/patent/tool-literature/src/index.ts:48`](../packages/patent/tool-literature/src/index.ts)
...
抽象服务类——部署时加载具体的实现包而非抽象类本身（[能力接缝](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.md)）。
