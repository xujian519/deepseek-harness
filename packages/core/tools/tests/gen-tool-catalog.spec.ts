...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual(['analyze_patent_figure', 'ask_user_question', 'bash', 'bash', 'claim_chart_build', 'cordis_define', 'cordis_inspect_list', 'cordis_inspect_query', 'cordis_inspect_self', 'cordis_run', 'cordis_stop', 'cordis_undefine', 'create_goal', 'draft_claims', 'draft_specification', 'edit', 'evaluate_evidence', 'exit_plan_mode', 'flexible_plan', 'get_goal', 'glob', 'grep', 'interrupt_agent', 'job_kill', 'job_list', 'job_output', 'knowledge_note_save', 'list_agents', 'lsp', 'paper_list_sources', 'paper_search', 'patent_case_search', 'patent_eval', 'patent_kg_query', 'patent_legal_status', 'patent_metadata', 'patent_pdf_download', 'patent_plan_task', 'patent_search', 'patent_wiki_search', 'patent_worker_validate', 'patent_workflow', 'patent_workflow_run', 'pwsh', 'ralph', 'read', 'read_image', 'recognize_chemical_structure', 'render_patent_document', 'report', 'rule_check', 'run_code', 'schedule_create', 'schedule_delete', 'schedule_list', 'search_patent_figure', 'self_evolve_inspect_patterns', 'self_evolve_now', 'send_message', 'session_event_read', 'session_event_search', 'session_event_trace', 'session_search', 'session_trace', 'skill', 'str_replace_editor', 'subagent', 'terminal_close', 'terminal_list', 'terminal_open', 'terminal_read', 'terminal_send', 'terminal_signal', 'todo_write', 'triz', 'update_goal', 'validate_specification', 'web_fetch', 'web_search', 'workflow', 'write'])
