...
Partial supersession of [2026-08-28-upstream-v0.1.2-alpha.1-sync](../process/2026-08-28-upstream-v0.1.2-alpha.1-sync.md): its follow-up 3 is closed here, and its follow-up 1 (readFileText Remote gateway) closed on 2026-09-19 in [2026-09-19-document-studio-preview-over-the-workspace-files-remote](2026-09-19-document-studio-preview-over-the-workspace-files-remote.md); follow-up 2 (synapse live-reply) remains open and keeps that note active. Partial supersession of [2026-08-26-hygiene-gate-debt-and-conflict](../../proposed/bug-fix/2026-08-26-hygiene-gate-debt-and-conflict.md): its item 3 is implemented; the `bundle/im` knip items remain with their window.
