/**
 * First Principles methodology: break a problem down to fundamental truths and
 * rebuild from there. Ported from Sati's
 * src/methodology/runtime/components/first-principles.ts.
 * @module @deepseek-ai/dsh-methodology/runtime/components/first-principles
 */
