...
export function assertServiceablePwshConfig(config: Config): void {
  assertPositiveFinite('pwsh-local: timeoutMs', config.timeoutMs.get())
  assertPositiveFinite('pwsh-local: maxTimeoutMs', config.maxTimeoutMs.get())
  assertPositiveFinite('pwsh-local: maxOutputBytes', config.maxOutputBytes.get())
  assertPositiveFinite('pwsh-local: maxSpillBytes', config.maxSpillBytes.get())
  assertPositiveFinite('pwsh-local: graceMs', config.graceMs.get())
