...
- **The open-route body ceiling is fixed.** `MAX_BODY_BYTES` (64 KiB) is the security invariant of the open route: a larger body is drained and refused, never accepted up to a configured limit.
