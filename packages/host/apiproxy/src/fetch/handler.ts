...
import {
  ...
  hostPickDirectoryRequestSchema, hostReadFileTextRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.readFileText': { schema: hostReadFileTextRequestSchema, invoke: (api, r, signal) => api.host.readFileText(r, signal) },
