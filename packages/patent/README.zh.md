...
| 包 | 职责 | ctx key |
|---|---|---|
| [`patent-data/`](patent-data/README.zh.md) | 专利数据访问：nuo-patent 映射/检索 provider + ego-browser 子进程 provider。 | `patentData` |
...
| [`patent-fees/`](patent-fees/README.zh.md) | 费用索引与计价：案件应缴费种、费用减缴、年费分档与滞纳金规则、patent_fees 工具。 | （注册于 `ctx.tools`） |
