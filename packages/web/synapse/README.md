...
None, as the host half renders committed session events to the canvas and adds no prompt prose, tool schemas, or request-context content to any model request.
