...
- **位置**:`packages/llm/llm-deepseek/src/protocols/chat-completions/translate.ts`(探查时为 `llm-deepseek/src/translate.ts:120-127`,该文件后由上游按 protocol 拆分)
