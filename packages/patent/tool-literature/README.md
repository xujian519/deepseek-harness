...
- **The browser fallback channel is browser-use only** — `paper_download`'s fallback opens the record page through the browser-use extractor; the ego-browser channel used by patent_pdf_download is not wired into literature downloads yet.
