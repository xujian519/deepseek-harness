 ...
 */
import { createElement, useEffect, useState, type ComponentType, type FunctionComponent, type ReactNode } from 'react'
...
function LazyChunkView<P>({ chunk, pick, props }: LazyChunkViewProps<P>): ReactNode {
  ...
  return createElement(
    state.Comp as unknown as FunctionComponent<Record<string, unknown>>,
