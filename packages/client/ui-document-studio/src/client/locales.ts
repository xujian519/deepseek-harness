...
export const zh = {
  ...
  'studio.file.checkedPassed': '机器核验通过',
  'studio.file.checkedFindings': '机器核验 {count} 项提示',
  'studio.file.checkedSkipped': '未逐字核验',
  'studio.file.checkedFailed': '机器核验未完成',
  ...
  'studio.print.tooLarge': '文件超过 {limit}，无法通过预览完整打印；请打开原文件后从浏览器打印。',
}
...
export const en: Record<DocumentStudioKey, string> = {
  ...
  'studio.file.checkedPassed': 'Machine-checked',
  'studio.file.checkedFindings': '{count} machine-check findings',
  'studio.file.checkedSkipped': 'Not read as text',
  'studio.file.checkedFailed': 'Machine check incomplete',
  ...
  'studio.print.tooLarge': 'File exceeds {limit}; open the original to print the full document.',
}
