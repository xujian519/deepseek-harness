...
来源：[`packages/e2b/e2b/src/index.ts:50`](../packages/e2b/e2b/src/index.ts)
...
来源：[`packages/test-support/llm-replay/src/index.ts:1116`](../packages/test-support/llm-replay/src/index.ts)
...
来源：[`packages/mcp/mcp-client/src/index.ts:111`](../packages/mcp/mcp-client/src/index.ts)
...
来源：[`packages/core/system-prompt/src/index.ts:274`](../packages/core/system-prompt/src/index.ts)
...
来源：[`packages/core/tools/src/index.ts:638`](../packages/core/tools/src/index.ts)
...
- `@deepseek-ai/dsh-tool-plugin-market` — requires `tools` · `systemPrompt` · `pluginMarket` ([`packages/extensions/tool-plugin-market/src/index.ts`](../packages/extensions/tool-plugin-market/src/index.ts))
...
- `@deepseek-ai/dsh-desktop-seam` — abstract `Desktop` ([`packages/desktop/desktop-seam/src/index.ts`](../packages/desktop/desktop-seam/src/index.ts))
