...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'exit_plan_mode', 'flexible_plan', 'generate_patent_figure', 'get_goal', 'glob', 'grep',
      'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output', 'knowledge_note_save',
      'list_agents', 'list_agents', 'list_subagent_models', 'lsp', 'macos_app', 'macos_clipboard_get',
      'macos_clipboard_set', 'macos_notify', 'macos_open_path', 'macos_open_url', 'macos_speak',
      ...
      'patent_eval', 'patent_kg_query', 'patent_legal_status', 'patent_metadata', 'patent_pdf_download',
      'patent_plan_task', 'patent_search', 'patent_teams_add_member', 'patent_teams_archive',
      'patent_teams_claim_task', 'patent_teams_create', 'patent_teams_create_task',
      'patent_teams_delete', 'patent_teams_reassign_task', 'patent_teams_remove_member',
      'patent_teams_send_message', 'patent_teams_status', 'patent_teams_update_task',
      'patent_wiki_search', 'patent_worker_validate', 'patent_workflow', 'patent_workflow_run',
      'present', 'pwsh', 'pwsh', 'ralph', 'read', 'read_image', 'recognize_chemical_structure',
      'render_patent_document', 'rule_check', 'run_code', 'schedule_create', 'schedule_delete',
      ...
      'terminal_send', 'terminal_signal', 'todo_write', 'triz', 'update_goal', 'validate_specification',
      'wait_agent', 'web_fetch', 'web_search', 'workbench_link_patent_case', 'workflow', 'write',
    ])
